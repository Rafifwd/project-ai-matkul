...
/**
 * Badge kecil menampilkan status & info model ML yang aktif.
 * Cocok diletakkan di footer atau header layout.
 *
 * Contoh: ⚡ Hybrid AI v0.3.0 | RF Model | Accuracy: 89.2% | 1,640 samples
 */
