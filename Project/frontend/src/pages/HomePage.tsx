...
const FEATURES = [
  {
    Icon: IconFolder,
    title: 'Katalog Karier',
    description:
      'Jelajahi 10+ jalur karier IT terkurasi berbasis data O*NET. Lihat kebutuhan skill, soft skills, dan sumber belajar tiap karier.',
    to: '/careers',
    cta: 'Lihat Katalog',
  ...
  },
  {
    ...
    description:
      'Tidak tahu harus kemana? Isi profil skill-mu dan biarkan AI hybrid kami merekomendasikan karier terbaik untukmu.',
    to: '/discover',
  ...
  },
  {
    ...
    title: 'Validasi Karier',
    description:
      'Sudah punya target karier? Ukur kesiapanmu sekarang dan dapatkan roadmap belajar yang dipersonalisasi.',
    to: '/validate',
...
const STATS = [
  { value: '10+', label: 'Karier IT' },
  { value: 'Hybrid', label: 'Rule + ML Engine' },
  { value: 'SHAP', label: 'XAI Explainer' },
  { value: 'O*NET', label: 'Data Sumber' },
]
    ...
    <div className="animate-fade-in">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-indigo-50 to-violet-100">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/80 backdrop-blur-sm border border-indigo-200 text-indigo-700 text-xs font-semibold mb-8 shadow-sm">
            ...
            Hybrid Rule-Based + ML Engine v0.3.0
          </div>
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-slate-900 leading-tight mb-6">
            ...
            <br />
            <span className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 bg-clip-text text-transparent">Terbaikmu</span>
          </h1>

          <p className="max-w-2xl mx-auto text-lg text-slate-600 leading-relaxed mb-10">
            NalarPath AI membantu mahasiswa merekomendasikan dan memvalidasi karier secara
            realistis — berbasis data O*NET nyata, diperkuat Machine Learning, dan dijelaskan
            dengan SHAP Explainable AI.
          </p>
      ...
      <section className="bg-white">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-slate-900 mb-3">Tiga Fitur Utama</h2>
          <p className="text-slate-500 max-w-xl mx-auto">
            Dari eksplorasi hingga validasi, NalarPath AI memandumu langkah demi langkah.
          </p>
        </div>
      ...
      <section className="border-t border-slate-100 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-3">Bagaimana AI Kami Bekerja?</h2>
            <p className="text-slate-500 max-w-lg mx-auto">
              Sistem hybrid yang transparan dan dapat dijelaskan.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Mencocokkan skill pengguna dengan persyaratan minimum karier berbasis data O*NET yang dikurasi pakar.',
                color: 'bg-indigo-100 text-indigo-700 border-indigo-200',
              },
              {
                step: '02',
                title: 'ML Probability',
                desc: 'Random Forest / Gradient Boosting menganalisis 82 fitur sekaligus dan menghasilkan probabilitas kecocokan.',
                color: 'bg-violet-100 text-violet-700 border-violet-200',
              },
              {
                step: '03',
                title: 'SHAP Explanation',
                desc: 'SHAP values menjelaskan secara transparan mengapa AI memberikan rekomendasi tersebut.',
