// Centralized SVG icons to replace all emoji usage across the app.
// Uses Heroicons-inspired designs for a professional, consistent look.
...
function defaultProps(props: IconProps, defaultSize = 16) {
